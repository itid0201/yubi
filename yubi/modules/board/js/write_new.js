...
//			MultiFile.trigger('FileRemove', $("#write_file_wrap input[type=file]")[0].files, MultiFile, $(this));
														
//			console.log($.fn.MultiFile('data'));
//			var remove_idx = thisCheck.parents("li").index();
//			console.log(remove_idx);
//			console.log($("#write_file_wrap input[type=file]")[0].files);
			
//				console.log($('#write_file'));
//				$('#write_file_wrap input:file').MultiFile('reset');
//				console.log($('#write_file'));
			
	/*
	
	$("input#write_file.MultiFile-applied")[0] => file inputbox
	$("input#write_file.MultiFile-applied")[0].files => FileList 삭제됨 
	*/

/*			console.log($("#write_file").Multifile);
						//$(\'div.file_add > input[name="filename[]"]\').
//				$("div.file_add input[name='filename[]']").MultiFile('reset');
//				console.log($("div.file_add #write_file_wrap input[type='file']"));
...
//  $return .= 			'$(this).parents("div.file_add").find(\'input[name="filename[]"]:last\').click();' . CR;
							$("div.file_add #write_file_wrap .MultiFile")[0].files = df.files;
			//		console.log($("div.file_add #write_file_wrap .MultiFile")[0].files);
