...
$(function(){
			...
			default :
				break;
							...
							$(document).on("click", ".module_list_box .board_list_box .share_wrap .board_btn_share", function(){
								...
								/* 상세보기 */
								$(document).on("click", ".module_list_box .board_list .item > a, .module_list_box .board_list .item .cont_box > a, .module_list_box .board_list .item .thumb_box > a, .hot_board ul li.item > a", function(){
	...
	$(document).on("click", ".board_btn_box ul li.board_btn_reply a ", function(){
		...
		$.get(selfUrl+'?mode=view&return=json&idx='+pidx,function(data){														setTimeout(function(){
