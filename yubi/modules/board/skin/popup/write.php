							...
							<div class="module_write_box">
								<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
									...
									<div class="cont_write">
										...
										if( empty($data['top_start']) && empty($data['top_end']) ){
											$top_checked = '';	
											$top_disable = ' disabled="disabled" '; 											
										}else{
											$top_checked = ' checked="checked"';	
										...
										<div class="write_box date_select_box">
											<div class="module_t">
												...
												<label for="top_check">게시기간<em>(*)</em><!--<span class="icon"></span>--></label>
											</div>
											<div class="module_w">
												<div class="base_box date_box">
													...
													<label for="top_start" class="box_hidden">게시 시작시간</label>
												...
												<div class="base_box date_box">
													...
													<label for="top_end" class="box_hidden">게시 종료시간</label>
										...
										<div class="write_box">
											<div class="module_t"><label for="reg_name">작성자<em>(*)</em></label></div>
											<div class="module_w">
										...
										<div class="write_box">
											...
											<div class="module_w">
												<input type="text" id="link_url" name="link_url" class="module_text w80" value="<?php echo $data['link_url'] ?>" />
											</div>
										</div>															
										<div class="write_box">
											<div class="module_t"><label for="varchar_2">target</label></div>
											<div class="module_w">
										...
										<div class="write_box module_file">
											...
											<div class="module_w">
												<p class="file_size_cont"><?php echo $_SYSTEM['module_config']['banner_size_width']; ?> x <?php echo $_SYSTEM['module_config']['banner_size_height']; ?> 또는 같은비율</p>
												<?php 
												//print_r($data['file_list']);
												 ...
												 if($data['file_upload_count'] > 0) echo upload_box_alt_tour($data['file_list'], $iter, 0, $use_gallery_img, false, $data['file_upload_count'], $upload_image_size);
												?>
											</div>											
										</div>	
										<?php     
