...
<div class="module_view_box">
  ...
  <div class="contbox">
    	...
    	<?php
			...
			echo 	'<li><span class="date_title">노출기간 :</spna> '.$data['top_start'].' ~ '.$data['top_end'].'</li>';			
			echo 	'<li><span class="link_title">URL</spna> : <a href="'.(empty($data['link_url'])?'#none':$data['link_url']).'" '.(empty($data['link_url'])?'':' target ="_blank"').' >'.$data['link_url'].'</a></li>';					
			echo '</ul>';			
