										...
										<div class="write_box">
											...
											<div class="module_w">
												<div class="base_box date_box">
													...
													<input type="text" id="top_start" name="top_start" class="datetime datetime_normal" value="<?php echo str_replace("-","",$data['top_start']); ?>"  <?php echo empty($data['top_start'])?' placeholder="'.date('Ymd').'"':''; ?>  />
													<a href="#none" class="date_icon"></a> 
												</div>
												<span class="icon_text">~</span>
												<div class="base_box date_box">
													<label for="top_end" class="box_hidden">게시 종료시간</label>
													<input type="text" id="top_end" name="top_end" class="datetime datetime_normal" value="<?php echo str_replace("-","",$data['top_end']); ?>" <?php echo empty($data['top_end'])?' placeholder="'.date('Ymd',strtotime("+7 day")).'"':''; ?>  />
													<a href="#none" class="date_icon"></a>
												</div>
											</div>
										</div>
