...
if(!isset($data['use_process_1'])) $data['use_process_1']=null;
if(!isset($data['navi_parameter'])) $data['navi_parameter']=null;
if(!isset($data['search_parameter'])) $data['search_parameter']=null;
if(!isset($data['use_logoff_write'])) $data['use_logoff_write']=null;
if(!isset($data['use_category_1'])) $data['use_category_1']=null;
if(!isset($data['debug'])) $data['debug']=null;
