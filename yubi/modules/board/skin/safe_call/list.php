...
//		$print_table_tr  .=  '								</td>';
		...
		$print_table_tr  .=  '								<td>'.$buffer['varchar_3'].'<!-- '.$buffer['varchar_4'].'--></td>';
...
<div class="board_wrapper">
	<div class="module_list_box">
		...
		## -----------  인기글 : end
			//# 엑셀 출력 sub_mode=excel
		//	if( $_SYSTEM['permission']['admin'] == true ){
				echo '<div class="btn_p align_right"><a href="'.$_SERVER['PHP_SELF'].'?sub_mode=excel" class="p1 mar5">엑셀 내려받기</a></div>';
		//	}
		?>
