							...
							<div class="module_write_box">
								<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
									...
									<div class="cont_write">
										...
										<div class="write_box">
											<div class="module_t"><label for="phone">URL</label></div>
											<div class="module_w">
												<input type="text" class="input_basic phone" name="link_url" id="link_url" value="<?php echo $data['link_url'] ?>" />
											</div>
										</div>
										<!--내용부분-->
										...
										?>
										<div class="write_box module_file module_main_thumb">
											<div class="module_t"><strong>메인 이미지</strong><?php echo ( $_SYSTEM['module_config']['use_gallery_img'] == 'true')?'<em>(*)</em>':''?></div>
											<div class="module_w">												
