...
<div class="board_wrapper">
	<div class="module_list_box">
		...
		<div class="board_list_box">
			...
			/*20210507 검색박스 수정*/
			echo search_box_new_foreign('jp', $data['total_count'], $data['search_type'], $data['search_word'], $data['search_list'], $data['page_scale_search'], $data['page_scale'], $data['start_date'], $data['finish_date'], $data['search_parameter'],$data); 
			## -----------  검색 영역 : end
		...
		//	$navi_parameter = make_GET_parameter($data['navi_parameter']);
			$page_navi      = page_navigation_new($data['total_count'], $data['page_scale'], $data['block_scale'], $data['page'], $data['navi_parameter'],'list','jp');
	...
	## --------------------- 버튼 : start
	$print_button =  print_button_new_foreign('jp','list', $data['permission'], $data['parameter'], $url, $img_url, $user_info, $arr_data);
