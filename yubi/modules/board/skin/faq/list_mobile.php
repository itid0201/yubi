<link rel="stylesheet" href="<?php echo $_SERVER['SELF'] ?>css/faq_mobile.css" type="text/css" />
<?php	
	## 목록 리스트 ==========================================================
	/***********
	...
	***********/	
	...
	for($iter=0 ; $iter<$data['count'] ; $iter++) {
		...
		## ================================================================================================			
		$print_table_tr = '<li>	';
		$print_table_tr .= '	 <div class="question">	';
		$print_table_tr .= '     	<a href="#none"><span class="title">Q</span> <p>'.$buffer['title'].'</p> <span class="arrow"></span></a>	 ';
		if( $_SYSTEM['permission']['admin'] == true ) {		
			$print_table_tr .= '     <div class="modify">';
			$print_table_tr .= ' 		<a href="?idx='.$buffer['idx'].'&amp;mode=modify" class="l_btn_modify">수정</a>';
			$print_table_tr .= ' 		<a href="?idx='.$buffer['idx'].'&amp;mode=remove" class="l_btn_remove">삭제</a>';			
			$print_table_tr .= '		</div>	';
		}
		$print_table_tr .= '     </div>	';
		$print_table_tr .= '     <div class="anwser"><p>'.$contents.'</p></div>	';
		$print_table_tr .= '</li>	';
...
<div class="board_wrapper">
	<div class="module_list_box">
		...
		<div class="board_list_box">
			...
			echo ' <div class="faq_list"><ul class="board_list">'.$print_table.'</ul></div>';		
...
<script>
$(function(){
		$(document).on("click","div.question > a",function() {
			$(this).parent().next().stop().slideToggle();
			$(this).children("span.arrow").toggleClass("on");
			return false;
		});

		$(document).on("click",".l_btn_remove",function() {
