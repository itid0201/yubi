							...
							<div class="module_write_box">
								<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
									...
									<div class="title_write">										
										<label for="title">질문<em>(*)</em></label>
									...
									<div class="cont_write">
										...
										?>										
										<div class="write_box">
											<div class="module_t"><label for="reg_name"><?php echo $data['writer_display'] == 'department' ? '등록부서' : '등록자'; ?></label></div>
											<div class="module_w">
										...
										<div class="write_contbox">
											<div class="module_t" id="append_btn_zone">
												<strong>답변<em>(*)</em></strong><span>입력버튼을 클릭하면 아래에 입력박스가 생성됩니다.</span>
												<ul class="append_btn">
