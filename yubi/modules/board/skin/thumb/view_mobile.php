...
<div class="module_view_box">
  ...
  <div class="contbox">
    	...
    	<?php
			...
			## -------------- 콘텐츠
			if($_GET['idx'] == '70288' && $_SYSTEM['module_config']['board_id'] == 'njursc_center_news') {
				echo '<a href="https://www.ktv.go.kr/program/home/PG2210001D/content/625187" target="_blank">'.$contents.'</a>'; 
			} else {
				echo $contents; 		
			}	
