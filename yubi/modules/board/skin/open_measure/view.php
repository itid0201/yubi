...
$data['period_start'] = $data['period_start']!="" ? date('Y-m-d',strtotime($data['period_start'])) : "";
$data['period_end'] = $data['period_end']!="" ? date('Y-m-d',strtotime($data['period_end'])) : "";
############################# contetns #############################
...
<div class="board_wrapper">
	<div class="module_view_box">
		...
		<div class="contbox">
			<div class="viewinfo">
				<ul>
					<li><span class="subt">헹정처분정보</span><?php echo $data['varchar_2'];?></li>
					<li><span class="subt">상호명</span><?php echo $data['title'];?></li>
					<li><span class="subt">위반일자</span><?php echo $data['varchar_1']; ?></li>
					<li><span class="subt">공시일자</span><?php echo $data['period_start']." - ".$data['period_end']; ?></li>
					<li><span class="subt">대표자</span><?php echo $data['varchar_4'];?></li>
					<li><span class="subt">소재지</span><?php echo $data['varchar_5'];?></li>
					<li><span class="subt">조치사항</span><?php echo $data['varchar_6'];?></li>
					<li><span class="subt">조치결과</span><?php echo $data['varchar_7'];?></li>
				</ul>
			</div>
