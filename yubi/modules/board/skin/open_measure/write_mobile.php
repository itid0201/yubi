...
?>
						<div class="board_wrapper">
                           ...
                           <div class="write_box write_inputbox">										
										...
										<div class="module_w"><input type="text" class="module_text" name="varchar_4" value="<?php echo $data['varchar_4']; ?>" /></div>
									</div>         
                           <div class="write_box write_inputbox">										
										<div class="module_t"><label for="varchar_5">소재지</label></div>
										<div class="module_w"><input type="text" class="module_text" name="varchar_5" value="<?php echo $data['varchar_5']; ?>" /></div>
									</div>         
                           <div class="write_box write_inputbox">										
										<div class="module_t"><label for="varchar_6">조치사항</label></div>
										<div class="module_w"><input type="text" class="module_text" name="varchar_6" value="<?php echo $data['varchar_6']; ?>"/></div>
									</div>         
                           <div class="write_box write_inputbox">										
										<div class="module_t"><label for="varchar_7">조치결과</label></div>
										<div class="module_w"><input type="text" class="module_text" name="varchar_7" value="<?php echo $data['varchar_7']; ?>"/></div>
									</div>
