							...
							<div class="module_write_box">
								<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
									...
									<div class="cont_write">
										...
										<div class="write_box">
											<div class="module_t"><label for="reg_name">담당부서<em>(*)</em></label></div>
											<div class="module_w">
										...
										<div class="write_box module_privacy" >
											<div class="module_t"><strong>의회발언<em>(*)</em></strong></div>	
											<div class="privacy_textarea">
												<!--<input type=hidden name=title value="의회발언/시입장">-->
												<textarea id="contents" name="contents" rows=10><?php echo $data['contents']; ?></textarea>
											</div>
										</div>
										<div class="write_box module_privacy" >
											<div class="module_t"><strong>시입장<em>(*)</em></strong></div>	
											<div class="privacy_textarea"><textarea id="contents_en" name="contents_en" rows=10><?php echo $data['contents_en']; ?></textarea></div>
										</div>
										<?php
