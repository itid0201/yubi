							...
							<div class="module_write_box">
								<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
                                    ...
                                    <div class="title_write">										
										<label for="title">사업명칭<em>(*)</em></label>
										<input type="text" id="title" name="title" value="<?php echo $data['title']?>" placeholder="사업명칭" />
									</div>
									<div class="cont_write">
                                        ...
                                        <div class="write_box">
											...
											<div class="module_w">
												<input type="text" class="module_text" name="phone_1" id="phone_1" value="<?php if(empty($data['phone_1'])) echo $data['user_phone_1']; else echo $data['phone_1'] ?>" /> - <input type="text" class="module_text" name="phone_2" id="phone_2" value="<?php if(empty($data['phone_2'])) echo $data['user_phone_2']; else echo $data['phone_2'] ?>" /> - <input type="text" class="module_text" name="phone_3" id="phone_3" value="<?php if(empty($data['phone_3'])) echo $data['user_phone_3']; else echo $data['phone_3'] ?>" />
											</div>
										</div>
                                        <div class="write_box notice_box">
											<div class="module_t">	
											...
											<div class="module_w">	
												<input type="text" class="module_text" name="varchar_2" id="varchar_2" value="<?php if(empty($data['varchar_2'])) echo $data['user_birth']; else echo $data['varchar_2'] ?>" />
											</div>
										</div>
