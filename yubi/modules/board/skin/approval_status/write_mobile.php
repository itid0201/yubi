							...
							<div class="module_write_box">
								<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
									...
									<div class="cont_write">
										...
										<div class="write_box">
											<div class="module_t">	
												<label for="varchar_1">구분<em>(*)</em></label>
											</div>
											<div class="module_w">	
												<input type="text" name="varchar_1" id="varchar_1" class="module_text" value="<?php echo $data['varchar_1']; ?>" />
											</div>
										</div>
										<div class="write_box">
											<div class="module_t">	
												<label for="varchar_2">사업승인일</label>
											</div>
											<div class="module_w">	
												<input type="text" name="varchar_2" id="varchar_2" class="module_text" value="<?php echo $data['varchar_2']; ?>" />
											</div>
										</div>
										<div class="write_box">
											<div class="module_t">	
												<label for="varchar_3">건축위치</label>
											</div>
											<div class="module_w">	
												<input type="text" name="varchar_3" id="varchar_3" class="module_text" value="<?php echo $data['varchar_3']; ?>" />
											</div>
										</div>
										<div class="write_box">
											<div class="module_t">	
												<label for="varchar_4">지번</label>
											</div>
											<div class="module_w">	
										...
										<div class="write_box">
											<div class="module_t">	
												<label for="varchar_5">사업주체</label>
											</div>
											<div class="module_w">	
