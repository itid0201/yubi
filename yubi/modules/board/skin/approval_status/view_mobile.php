  ...
  <div class="contbox">
	...
	if($_SYSTEM['module_config']['board_id'] == 'www_newsletter_req') {
		...
		if($_SYSTEM['permission']['manage'] == true || $_SYSTEM['permission']['admin'] == true) echo '<p class="birth">주소 : ('.$data['zipcode'].') '.$data['address_1'].' '.$data['address_2'].'</p>';
			...
			echo '<ul>';
			echo '	<li><span class="subt">구분</span>'.$data['varchar_1'].'</li>';
			echo '	<li><span class="subt">사업승인일</span>'.$data['varchar_2'].'</li>';
			echo '	<li><span class="subt">건축위치</span>'.$data['varchar_3'].'</li>';
			echo '	<li><span class="subt">지번</span>'.$data['varchar_4'].'</li>';
			echo '	<li><span class="subt">사업주체</span>'.$data['varchar_5'].'</li>';
			echo '	<li><span class="subt">층수</span>'.$data['varchar_6'].'</li>';
			echo '	<li><span class="subt">동수</span>'.$data['varchar_7'].'</li>';
			echo '	<li><span class="subt">세대수</span>'.$data['varchar_8'].'</li>';
			echo '	<li><span class="subt">비고</span>'.$data['varchar_9'].'</li>';
			echo '</ul>';		
			echo '</div>';
