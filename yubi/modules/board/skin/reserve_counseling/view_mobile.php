...
<div class="module_view_box">
	...
	<div class="contbox">
    	...
    	<?php	
			...
			echo '<ul>';
			echo $data['reg_name'] == '' ? '' : '<li><span class="subt">등록자</span>'.$data['reg_name'].'</li>';
			echo $data['zipcode'] == '' ? '' : '<li><span class="subt">주소</span>['.$data['zipcode'].'] '.$data['address_1'].' '.$data['address_2'].'</li>';
