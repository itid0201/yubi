...
?>
									...
									<div class="cont_write">
										...
										<div class="write_box date_select_box">
											<div class="module_t">												
												...
												<label for="notice_check">공지등록<span class="icon"></span></label></div>
											<div class="module_w">	
										...
										<?php if($_SYSTEM['module_config']['board_id'] == 'www_newsletter_req' || $_SYSTEM['module_config']['board_id'] == 'www_resere_counseling') { ?>
										<div class="write_box">
										...
										<div class="write_box write_inputbox">
											<div class="module_t">
												<label for="reg_name">주소<em>(*)</em></label>
											</div>
											<div class="module_w">
												<div class="item">
												<?php
   ...
   <?php 
										...
										<div class="write_box module_privacy">
											...
											<div class="module_w">
												<p class="basic">아래 개인정보처리방침을 반드시 읽어보시고 '동의'에 체크하신 후 '확인'버튼을 눌러주세요</p>        
												<p class="mat10">
													<textarea name="privacy_htm" id="privacy_html" rows="5" cols="100" readonly class="minwon_privacy_txt"><?php echo stripslashes($_SYSTEM['module_config']['privacy_msg']) ?></textarea>
												</p>
												<p class="mat20">
