...
<div class="board_wrapper">
	<div class="module_view_box">
		<div class="view_titlebox">
			...
			<dl>
				<dt class="text_hidden">浏览次数</dt><dd><?php echo date('Y.m.d H:i',strtotime($data['reg_date'])); ?></dd>
				<dt>瀏覽次數</dt><dd><?php echo $data['visit_cnt']; ?></dd>
				<dt>登记者</dt><dd><?php echo($data['writer_display'] == 'department' ? $data['depart_name'] : $data['reg_name']) ?></dd>
			</dl>
		</div>
		<div class="contbox">
			<?php  
		...
		if( $data['use_pager'] == 'true' ){			
			...
			echo print_pager_foreign("ch", $data['nearby_articles'],$data['parameter'],$_SERVER['PHP_SELF']);
		}
		## ---------------------
