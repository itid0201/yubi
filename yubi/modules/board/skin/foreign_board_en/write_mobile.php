...
?>
							...
							<div class="module_write_box">
								<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
									...
									<div class="title_write">										
										<label for="title">Disclosure status<em>(*)</em></label>
									...
									<div class="cont_write">
										...
										<div class="write_box date_select_box">
											...
											<div class="module_w">	
												<div class="base_box date_box">
													...
													<label for="top_start" class="box_hidden">Notice start time</label>
												...
												<div class="base_box date_box">
													...
													<label for="top_end" class="box_hidden">Notice end time</label>
										...
										<div class="write_box module_theme">
											<div class="module_t"><label for="category_1">Category</label></div>
											<div class="module_w">
										...
										<div class="write_box date_select_box">
											<div class="module_t">
												...
												<label for="period_check">Period<span class="icon"></span></label>
											</div>
											<div class="module_w">
												<div class="base_box date_box">
										...
										<div class="write_box write_inputbox">
											<div class="module_t"><label for="reg_name">Member tel<em>(*)</em></label></div>
											<div class="module_w">
												<?php
												...
												<span class="next mat5"> * ex) 010-1234-1234</span>
											</div>
										</div>
										<div class="write_box write_inputbox">
											<div class="module_t"><label for="reg_name">Member address<em>(*)</em></label></div>
											<div class="module_w">
												<tr>
													<div class="item">
													<?php
										...
										<div class="write_contbox">
											<div class="module_t" id="append_btn_zone">
												...
												<ul class="append_btn">
													<li class="text_append"><a href="#none"><span class="icon"></span>Text</a></li>
													<li class="image_append">
														...
														<a href="#none" class="_write_file_icon"><span class="icon"></span>Image</a>
													</li>
													<li class="link_append"><a href="#none"><span class="icon"></span>Link</a></li>
												</ul>												
											</div>
   ...
   <?php 
                                        ...
                                        ?>
                                        <div class="write_box">
											<div class="module_t"><label for="phone">Tel<em>(*)</em></label></div>
											<div class="module_w">
                                        ...
                                        <div class="write_box notice_box">
											<div class="module_t">	
												<label for="varchar_2">Birth<em>(*)</em></label>
                                            </div>
											<div class="module_w">	
...
<script src="<?php echo $_SERVER['SELF']; ?>js/write_mobile_foreign.js" ></script>