...
//echo '<pre>';print_r( $data );exit;
	...
	for($iter=0 ; $iter < $data['count'] ; $iter++) {
       ...
       $varchar_3 = substr($buffer['varchar_3'],0,4).'-'.substr($buffer['varchar_3'],4,2).'-'.substr($buffer['varchar_3'],6,2);
       $varchar_4 = substr($buffer['varchar_3'],0,4).'-'.substr($buffer['varchar_4'],4,2).'-'.substr($buffer['varchar_4'],6,2);
...
//}		
		$print_table_tr  .=  '    						</a>';
		$print_table_tr  .=  '    					</div>';
		$print_table_tr  .=  '    					<div class="cont_box youth_program_box">';
		...
		$print_table_tr  .=  '<div class="shortcut_info">';
        
        if(!empty($buffer['top_start'])) $print_table_tr  .=  '    						<p><span>신청기간</span>'.$buffer['top_start'].'~'.$buffer['top_end'].'</p>';		
        if(!empty($buffer['varchar_3']))$print_table_tr  .=  '    						<p><span>교육기간</span>'.$varchar_3.'~'.$varchar_4.'</p>';		
		if(!empty($buffer['varchar_7'])) $print_table_tr  .=  '    						<p><span>교육장소</span>'.$buffer['varchar_7'].'</p>';		
		if(!empty($buffer['varchar_6'])) $print_table_tr  .=  '    						<p><span>교육정원</span>'.$buffer['varchar_6'].'</p>';
        $print_table_tr .= '</div>';		
...
<div class="board_wrapper">
	<div class="module_list_box">
        ...
        <ul class="cate_list youth_program">
            <li <?php if($_REQUEST['sub_mode']=="ing" || empty($_REQUEST['sub_mode'])) echo 'class="active"'; ?>><a href="/najuyouth/program/guide?sub_mode=ing">접수중</a></li>
            <li <?php if($_REQUEST['sub_mode']=="end") echo 'class="active"'; ?>><a href="/najuyouth/program/guide?sub_mode=end">모집마감</a></li>
            <li <?php if($_REQUEST['sub_mode']=="wait") echo 'class="active"'; ?>><a href="/najuyouth/program/guide?sub_mode=wait">접수대기</a></li>
            <li <?php if($_REQUEST['sub_mode']=="all") echo 'class="active"'; ?>><a href="/najuyouth/program/guide?sub_mode=all">전체</a></li>
        </ul>
