							...
							<div class="module_write_box">
								<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
									...
									<div class="cont_write">
										...
										if($_SYSTEM['module_config']['board_id'] != 'www_lecturer') {
										...
										<?php } ?>
										<div class="write_box">
											<div class="module_t"><label for="reg_name"><?php echo $data['writer_display'] == 'department' ? '등록부서' : '강사명'; ?><em>(*)</em></label></div>
											<div class="module_w">
										...
										<div class="write_box notice_box">
											<div class="module_t">	
												<label for="varchar_1">성별<em>(*)</em></label>
                                            </div>
											<div class="module_w">	
												<input type="radio" id="man" name="varchar_1" class="_chk_input" value="남" <?php echo ($data['varchar_1']=='남' ? 'checked="checked"' : NULL);?> /><label for="man">남자</label>
												<input type="radio" id="women" name="varchar_1" class="_chk_input" value="여" <?php echo ($data['varchar_1']=='여' ? 'checked="checked"' : NULL);?> /><label for="women">여자</label>
											</div>
										</div>
										<!--div class="write_box notice_box">
											<div class="module_t">	
												<label for="varchar_2"><em>(*)</em>
												</label>
                                            </div>
											<div class="module_w">	
												<input type="text" name="varchar_2" id="varchar_2" class="transparent_box" value="<?php echo $data['varchar_2']; ?>" />
											</div>
										</div-->
										<div class="write_box notice_box">
											<div class="module_t">	
												<label for="varchar_3 w100">경력1<em>(*)</em>
												</label>
                                            </div>
											<div class="module_w">	
												<input type="text" name="varchar_3" id="varchar_3" class="module_text _chk_input" value="<?php echo $data['varchar_3']; ?>" />
											</div>
										</div>
										<div class="write_box notice_box">
											<div class="module_t">	
												<label for="varchar_4">경력2
												</label>
                                            </div>
											<div class="module_w">	
										...
										<div class="write_box notice_box">
											<div class="module_t">	
												<label for="varchar_7">경력5
												</label>
                                            </div>
											<div class="module_w">	
												<input type="text" name="varchar_7" id="varchar_7" class="module_text" value="<?php echo $data['varchar_7']; ?>" />
											</div>
										</div>
										<div class="write_box notice_box">
											<div class="module_t">	
												<label for="varchar_8">경력6
												</label>
                                            </div>
											<div class="module_w">	
												<input type="text" name="varchar_8" id="varchar_8" class="module_text" value="<?php echo $data['varchar_8']; ?>" />
											</div>
										</div>
										<div class="write_box notice_box">
											<div class="module_t">	
												<label for="varchar_9">경력7
												</label>
                                            </div>
											<div class="module_w">	
												<input type="text" name="varchar_9" id="varchar_9" class="module_text" value="<?php echo $data['varchar_9']; ?>" />
											</div>
										</div>
