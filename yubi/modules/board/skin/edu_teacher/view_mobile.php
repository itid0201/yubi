  ...
  <div class="contbox">
	...
	if($_SYSTEM['module_config']['board_id'] == 'www_newsletter_req') {
		...
		if($_SYSTEM['permission']['manage'] == true || $_SYSTEM['permission']['admin'] == true) echo '<p class="birth">주소 : ('.$data['zipcode'].') '.$data['address_1'].' '.$data['address_2'].'</p>';
			...
			echo '<ul>';
			if(!empty($data['reg_name'])) echo '<li><span class="subt">강사명</span>'.$data['reg_name'].'</li>';
			if(!empty($data['varchar_1'])) echo '<li><span class="subt">성별</span>'.$data['varchar_1'].'</li>';			
			if(!empty($data['varchar_3'])) echo '<li><span class="subt">경력1</span>'.$data['varchar_3'].'</li>';
			if(!empty($data['varchar_4'])) echo '<li><span class="subt">경력2</span>'.$data['varchar_4'].'</li>';
			if(!empty($data['varchar_5'])) echo '<li><span class="subt">경력3</span>'.$data['varchar_5'].'</li>';
			if(!empty($data['varchar_6'])) echo '<li><span class="subt">경력4</span>'.$data['varchar_6'].'</li>';
			if(!empty($data['varchar_7'])) echo '<li><span class="subt">경력5</span>'.$data['varchar_7'].'</li>';
			if(!empty($data['varchar_8'])) echo '<li><span class="subt">경력6</span>'.$data['varchar_8'].'</li>';
			if(!empty($data['varchar_9'])) echo '<li><span class="subt">경력7</span>'.$data['varchar_9'].'</li>';
