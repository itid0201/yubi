							...
							<div class="module_write_box">
								<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
									...
									<div class="cont_write">
										...
										?>				
										<?php if($_SYSTEM['module_config']['board_id'] != 'www_lecturer') { ?>
										<?php
										...
										<div class="write_box notice_box">
											<div class="module_t">	
												<label for="varchar_3">경력1<em>(*)</em>
												</label>
                                            </div>
											<div class="module_w">	
												<input type="text" name="varchar_3" id="varchar_3" class="module_text w100 _chk_input" value="<?php echo $data['varchar_3']; ?>" />
											</div>
										</div>
										<div class="write_box notice_box">
											<div class="module_t">	
											...
											<div class="module_w">	
												<input type="text" name="varchar_4" id="varchar_4" class="module_text w100" value="<?php echo $data['varchar_4']; ?>" />
											</div>
										</div>
										<div class="write_box notice_box">
											<div class="module_t">	
											...
											<div class="module_w">	
												<input type="text" name="varchar_5" id="varchar_5" class="module_text w100" value="<?php echo $data['varchar_5']; ?>" />
											</div>
										</div>
										<div class="write_box notice_box">
											<div class="module_t">	
											...
											<div class="module_w">	
												<input type="text" name="varchar_6" id="varchar_6" class="module_text w100" value="<?php echo $data['varchar_6']; ?>" />
											</div>
										</div>
										<div class="write_box notice_box">
											<div class="module_t">	
											...
											<div class="module_w">	
												<input type="text" name="varchar_7" id="varchar_7" class="module_text w100" value="<?php echo $data['varchar_7']; ?>" />
											</div>
										</div>
										<div class="write_box notice_box">
											<div class="module_t">	
											...
											<div class="module_w">	
												<input type="text" name="varchar_8" id="varchar_8" class="module_text w100" value="<?php echo $data['varchar_8']; ?>" />
											</div>
										</div>
										<div class="write_box notice_box">
											<div class="module_t">	
											...
											<div class="module_w">	
												<input type="text" name="varchar_9" id="varchar_9" class="module_text w100" value="<?php echo $data['varchar_9']; ?>" />
											</div>
										</div>
