							...
							<div class="module_write_box">
								<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
									...
									<div class="cont_write">
										...
										if($data['use_top'] == 'true' && $_SYSTEM['permission']['admin'] == 'true' && in_array($data['mode'],array("write","modify") ) ){	
											if( $data['top'] == 'y' ){
										...
										<div class="write_box write_inputbox">
											...
											<div class="module_w">
												...
												<div class="split_box r_none">
													<input type="text" name="phone_1" id="phone_1" value="<?php echo $phone_1;?>" class="text_phone module_text" numberonly />
													-</div>
												<div class="split_box r_none"><input type="text" name="phone_2" id="phone_2" value="<?php echo $phone_2;?>" class="text_phone module_text" numberonly />-</div>
												<div class="split_box r_none"><input type="text" name="phone_3" id="phone_3" value="<?php echo $phone_3;?>" class="text_phone module_text" numberonly/></div>												
											</div>
										</div>
										<div class="write_box write_inputbox">
											<div class="module_t"><label for="email">이메일<em>(*)</em></label></div>
											<div class="module_w">
												<input type="text" class="module_text" name="email" id="email" value="<?php echo $data['email'];?>" />
											</div>
										</div>
										<div class="write_box write_inputbox">
											<div class="module_t"><label for="address">주소<em>(*)</em></label></div>
											<div class="module_w">
												<tr>
													<div class="item">
													<?php
										...
										<div class="write_box notice_box">
											<div class="module_t">												
												<label for="notice_check">회신방법</label></div>
											<div class="module_w">	
												<input type="radio" name="varchar_1" id="mail" value="메일" <?php echo ($data['varchar_1'] == '메일' ? 'checked="checked"' : ''); ?> /><label for="mail">메일</label>&nbsp;&nbsp;&nbsp;
												<input type="radio" name="varchar_1" id="post" value="우편" <?php echo ($data['varchar_1'] == '우편' ? 'checked="checked"' : ''); ?> /><label for="post">우편</label>
											</div>
										</div>
...
if( $_SERVER['REMOTE_ADDR'] == "49.254.140.140" && $_SESSION['user_id'] == "jini0808" ){
	//ob_clean();	print_r( $data['keyword']);	exit;
										...
										<?php     
											...
											*/
											if($_SYSTEM['module_config']['use_privacy_write'] == 'true' && $_SYSTEM['module_config']['use_logoff_write'] == 'true'){ // 실제 사용 되어야할 if문
...
<script src="<?php echo $_SERVER['SELF']; ?>js/write_regulatory.js?build=<?php echo SERIAL;?>" ></script>