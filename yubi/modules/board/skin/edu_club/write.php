							...
							<div class="module_write_box">
								<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
                                    ...
                                    <div class="title_write">										
										<label for="title">동아리명<em>(*)</em></label>
										<input type="text" id="title" name="title" value="<?php echo $data['title']?>" placeholder="동아리명" />
									</div>
									<div class="cont_write">
										...
										?>				
										<?php if($_SYSTEM['module_config']['board_id'] != 'www_study_circle') { ?>
										<?php
										...
										<div class="write_box write_inputbox">
											...
											<div class="split_box r_none">
												<input type="text" name="phone_1" id="phone_1" value="<?php echo $phone_1;?>" class="text_phone module_text _chk_input" maxlength="3" title="연락처 앞자리" numberonly />
												- <input type="text" name="phone_2" id="phone_2" value="<?php echo $phone_2;?>" class="text_phone module_text _chk_input" maxlength="4" title="연락처 중간자리" numberonly />
												- <input type="text" name="phone_3" id="phone_3" value="<?php echo $phone_3;?>" class="text_phone module_text _chk_input" maxlength="4" title="연락처 뒷자리" numberonly />
											</div>
