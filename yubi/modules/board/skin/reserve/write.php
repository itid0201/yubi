				...
				<?php 
					...
					if($_SYSTEM['module_config']['board_id'] == 'www_assist_service') {
						...
						<div class="write_box">
							...
							<div class="module_w">	
								<input type="text" name="varchar_1" id="varchar_1" class="module_text" value="'.$data['varchar_1'].'" />
							</div>
						</div>';
						echo '
						<div class="write_box">
							...
							<div class="module_w">	
								<input type="text" name="varchar_2" id="varchar_2" class="module_text" value="'.$data['varchar_2'].'" />
							</div>
						</div>';
					}
				...
				<div class="write_box write_inputbox">
					...
					<div class="module_w">
						...
						<div class="split_box r_none">
							<input type="text" name="phone_1" id="phone_1" value="<?php echo $phone_1;?>" class="text_phone module_text"  maxlength="3"  />
							-</div>
						<div class="split_box r_none"><input type="text" name="phone_2" id="phone_2" value="<?php echo $phone_2;?>" class="text_phone module_text"  maxlength="4" />-</div>
						<div class="split_box r_none"><input type="text" name="phone_3" id="phone_3" value="<?php echo $phone_3;?>" class="text_phone module_text"  maxlength="4" /></div>			
					</div>
				</div>
				<div class="write_box write_inputbox">
