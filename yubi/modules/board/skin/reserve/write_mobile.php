				...
				<div class="cont_write">
					...
					<div class="write_box write_inputbox">
						...
						<div class="module_w">
							...
							?>
							<input type="text" class="module_text" name="phone_1" id="phone_1" value="<?php echo $phone_1;?>" maxlength="3" />
							- <input type="text" class="module_text" name="phone_2" id="phone_2" value="<?php echo $phone_2;?>" maxlength="4" />
							- <input type="text" class="module_text" name="phone_3" id="phone_3" value="<?php echo $phone_3;?>" maxlength="4" />
							<span class="next mat5"> * 입력예) 010-1234-1234</span>
						</div>
					</div>
					<div class="write_box write_inputbox">
						<div class="module_t"><label for="email">이메일</label></div>
						<div class="module_w">
