			...
			<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
				...
				<div class="cont_write">
					...
					<div class="write_box">
						...
						<div class="module_w">
							<input type="text" class="module_text w100" name="contents" id="contents" value="<?php echo $data['contents']; ?>" />
						</div>
					</div>
					<div class="write_box">
					...
					<div class="write_box">
						...
						<div class="module_w">
							<input type="text" class="module_text w100" name="varchar_1" id="varchar_1" value="<?php echo $data['varchar_1']; ?>" />
						</div>
					</div>
					<div class="write_box">
						<div class="module_t"><label for="varchar_2">조례</label></div>
						<div class="module_w">
							<input type="text" class="module_text w100" name="varchar_2" id="varchar_2" value="<?php echo $data['varchar_2']; ?>" />
						</div>
					</div>
					<div class="write_box">
						<div class="module_t"><label for="varchar_3">규칙</label></div>
						<div class="module_w">
							<input type="text" class="module_text w100" name="varchar_3" id="varchar_3" value="<?php echo $data['varchar_3']; ?>" />
						</div>
					</div>
					<div class="write_box">
						<div class="module_t"><label for="varchar_4">훈령</label></div>
						<div class="module_w">
							<input type="text" class="module_text w100" name="varchar_4" id="varchar_4" value="<?php echo $data['varchar_4']; ?>" />
						</div>
					</div>
					<div class="write_box">
						<div class="module_t"><label for="varchar_5">예규</label></div>
						<div class="module_w">
							<input type="text" class="module_text w100" name="varchar_5" id="varchar_5" value="<?php echo $data['varchar_5']; ?>" />
						</div>
					</div>
					<div class="write_box">
						<div class="module_t"><label for="varchar_6">고시등</label></div>
						<div class="module_w">
							<input type="text" class="module_text w100" name="varchar_6" id="varchar_6" value="<?php echo $data['varchar_6']; ?>" />
						</div>
					</div>
					<div class="write_box">
					...
					<div class="write_box">
						...
						<div class="module_w">
							<input type="text" class="module_text w100" name="varchar_8" id="varchar_8" value="<?php echo $data['varchar_8']; ?>" />
						</div>
					</div>
					<div class="write_box">
