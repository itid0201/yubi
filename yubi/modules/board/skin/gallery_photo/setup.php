  	<table class="setup_table" cellspacing="0" cellpadding="0" border="0" summary="">
		...
		<tr>
          ...
          <label>
        	...
        	<!--<tr><th scope="row">목록 넓이 설정( 모자이크형 갤러리에서만 사용)</th><td><input type="text" name="gallary_width_size" class="number_only" value="<?php echo empty($module_config['gallary_width_size'])?910:$module_config['gallary_width_size'];?>" size="4" />px</td>--></tr>            
        </tbody>
      </table>    