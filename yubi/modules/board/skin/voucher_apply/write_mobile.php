							...
							<div class="module_write_box voucher_request">
								<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
									...
									<div class="cont_write">
										...
										<div class="write_box">
											<div class="module_t">	
												<label for="varchar_6">신청상태 구분<em>(*)</em></label>
											</div>
											<div class="module_w">
										...
										<div class="write_box write_inputbox">
											<div class="module_t">
												<label for="reg_name">사업장 소재지<em>(*)</em></label>
											</div>
											<div class="module_w">
												<div class="item">
												<?php
										...
										<div class="write_box write_inputbox">
											<div class="module_t">
												<label for="varchar_1">본점 소재지<em>(*)</em></label>
											</div>
											<div class="module_w">
												<div class="item">
												<?php
										...
										<div class="write_box">
											<div class="module_t"><label for="phone">매장 전화번호<em>(*)</em></label></div>
											<?php
											...
											<div class="module_w">
												<div class="split_box">   
													<input type="text" name="tel_1" id="tel_1" value="<?php echo $tel_1;?>" class="module_text text_phone _chk_input isnumber"  maxlength="3" numberonly/>
													- <input type="text" name="tel_2" id="tel_2" value="<?php echo $tel_2;?>" class="module_text text_phone _chk_input isnumber"  maxlength="4" numberonly/>
													- <input type="text" name="tel_3" id="tel_3" value="<?php echo $tel_3;?>" class="module_text text_phone _chk_input isnumber"  maxlength="4" numberonly/>
												</div>
											</div>
										</div>
										...
										<div class="write_box">
											<div class="module_t"><label for="phone">휴대전화<em>(*)</em></label></div>
											<?php
											...
											<div class="module_w">
												<div class="split_box">   
													<input type="text" name="phone_1" id="phone_1" value="<?php echo $phone_1;?>" class="module_text text_phone _chk_input isnumber"  maxlength="3" numberonly/>
													- <input type="text" name="phone_2" id="phone_2" value="<?php echo $phone_2;?>" class="module_text text_phone _chk_input isnumber"  maxlength="4" numberonly/>
													- <input type="text" name="phone_3" id="phone_3" value="<?php echo $phone_3;?>" class="module_text text_phone _chk_input isnumber"  maxlength="4" numberonly/>
												</div>
											</div>
										</div>
