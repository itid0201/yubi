							...
							<div class="module_write_box">
								<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
									...
									<div class="cont_write">
										...
										<div class="write_box">
											<div class="module_t">	
												<label for="varchar_1">신청상태 구분</label>
											</div>
											<div class="module_w">
												<input type="radio" name="varchar_1" id="new" value="신규신청"><label for="new">신규신청</label>
												<input type="radio" name="varchar_1" id="change" value="변경"><label for="change">변경</label>
												<input type="radio" name="varchar_1" id="close" value="해지"><label for="close">해지</label>
											</div>
										</div>
										<div class="write_box">
											<div class="module_t">	
												<label for="varchar_2">사업자등록번호<em>(*)</em></label>
											</div>
											<div class="module_w">
												<input type="text" name="varchar_2" id="varchar_2" class="module_text _chk_input" value="<?php echo $data['varchar_2']; ?>" />
											</div>
										</div>
										<div class="write_box">
											<div class="module_t">	
												<label for="varchar_3">업태<em>(*)</em></label>
											</div>
											<div class="module_w">
										...
										<div class="write_box">
											...
											<div class="module_w">
												<div class="split_box">   
													<label for="phone_1" class="hidden">연락처 첫번쨰자리</label><input type="text" name="phone_1" id="phone_1" value="<?php echo $phone_1;?>" class="module_text text_phone _chk_input"  maxlength="3" numberonly/>
													- <label for="phone_2" class="hidden">연락처 중간자리</label><input type="text" name="phone_2" id="phone_2" value="<?php echo $phone_2;?>" class="module_text text_phone _chk_input"  maxlength="4" numberonly/>
													- <label for="phone_3" class="hidden">연락처 마지막자리</label><input type="text" name="phone_3" id="phone_3" value="<?php echo $phone_3;?>" class="module_text text_phone _chk_input"  maxlength="4" numberonly/>
												</div>
											</div>
										</div>
										<?php 
