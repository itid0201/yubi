<?php	
	...
	if($_SYSTEM['menu_info']['_board_id']=='www_voucher_request'){
		$writer_name = '신청자명';
	}
	...
	$print_table .=  '									<th scope="col" class="th_120px">'.($_SYSTEM['module_config']['board_id'] == 'njursc_newsrelease'?'보도일':'신청일').'</th>';	
	...
	/*$print_table .=  '									<th scope="col" class="th_150px">휴대전화</th>';*/
	$print_table .=  '									<th scope="col" class="th_100px">신청상태구분</th>';
	$print_table .=  '								</tr>';
	$print_table .=  '							</thead>';
	$print_table .=  '							<tbody>';
