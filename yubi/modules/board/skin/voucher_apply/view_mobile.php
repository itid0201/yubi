...
<div class="module_view_box">
	...
	<div class="contbox">
    	...
    	<?php	
			...
			echo '<ul>';
			echo '<li><span class="subt">상호명</span>'.$data['title'].'</li>';
			echo '<li><span class="subt">등록자명</span>'.$data['reg_name'].'</li>';
			echo '<li><span class="subt">등록일</span>'.$data['reg_date'].'</li>';
			echo '<li><span class="subt">휴대전화</span>'.$data['phone_1'].'-'.$data['phone_2'].'-'.$data['phone_3'].'</li>';
			echo '<li><span class="subt">신청상태 구분</span>'.$data['varchar_6'].'</li>';
			echo '<li><span class="subt">사업자등록번호</span>'.$data['varchar_7'].'</li>';
			echo '<li><span class="subt">업태</span>'.$data['varchar_8'].'</li>';			
			echo '<li><span class="subt">사업장 소재지</span>['.$data['zipcode'].'] '.$data['address_1'].' '.$data['address_2'].'</li>';
			echo '<li><span class="subt">본점 소재지</span>['.$data['varchar_1'].'] '.$data['varchar_2'].' '.$data['varchar_3'].'</li>';
			echo '<li><span class="subt">생년월일</span>'.$data['varchar_4'].'</li>';
			echo '<li><span class="subt">매장 전화번호</span>'.$data['varchar_5'].'</li>';
			echo '</ul>';		
			echo '</div>';
