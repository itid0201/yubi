...
<form name="frm" action="<?php echo $_SERVER['PHP_SELF']; ?>?mode=agree" method="post" onsubmit="return chkAgree(this);">
	...
	<div class="c_box2">
	<div class="in_box">
	<p class="basic">「복지 인터넷 상담실」은 관계법령 등에서 정하는 소관 업무의 수행을 위하여 다음과 같이 개인정보를 수집 및 이용합니다. 수집된 개인정보는 정해진 목적 이외의 용도로는 이용되지 않습니다.<br />※ 관계법령 : 민원사무 처리에 관한 법률 및 동법 시행령, 전자정부법 및 동법 시행령</p>
	</div>
	</div>
