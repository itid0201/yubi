    ...
    <form id="write_form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="selectForm"
      ...
      <div class="cont_write">
        ...
        <div class="write_box write_inputbox">
          <div class="module_t"><label for="phone_1">연락처<span class="rd">(*)</span><span
                class="hid">필수입력</span></label></div>
          <div class="module_w">
            <?php
            ...
            ?>
            <div class="split_box">
				<input type="text" name="phone_1" id="phone_1" value="<?php echo $phone_1;?>" class="module_text text_phone number" title="연락처 첫자리 입력"/>
			- <input type="text" name="phone_2" id="phone_2" value="<?php echo $phone_2;?>" class="module_text text_phone number" title="연락처 중간자리 입력"/>
			- <input type="text" name="phone_3" id="phone_3" value="<?php echo $phone_3;?>" class="module_text text_phone number" title="연락처 끝자리 입력"/>
			</div>
        ...
        <?php if ($_SYSTEM['module_config']['board_id'] !== 'www_resident_participation') { ?>
          <div class="write_box write_inputbox">
            <div class="module_t"><label for="zipcode_1">주소<span class="rd">(*)</span><span
                  class="hid">필수입력</span></label></div>
            <div class="module_w">
              <tr>
                <div class="item">
        ...
        <?php if ($_SYSTEM['module_config']['board_id'] == 'www_resident_participation') { ?>
          <div class="write_box write_inputbox">
            <div class="module_t"><label for="birth">생년월일</label></div>
            <div class="module_w">
              <input type="text" name="varchar_2" id="birth" value="<?php echo $data['varchar_2']?>">
              <span class="next mat5"> * 입력예) 1990-01-01</span>
            </div>
          </div>
...
<script>
$("#phone_1,#phone_2,#phone_3").on("keyup", function() {
