...
<h3 class="mat0"><?php echo $agree_title; ?></h3>
...
<form name="frm" action="<?php echo $_SERVER['PHP_SELF']; ?>?mode=agree" method="post" onsubmit="return chkAgree(this);">
	<h4>개인정보의 수집 및 이용 (개인정보보호법 제15조)</h4>
	<div class="agreeform_box">
	<h5>개인정보의 수집 및 이용목적</h5>
	<div class="c_box2">
	<div class="in_box">
	<p class="basic">「부동산불법거래신고센터」는 관계법령 등에서 정하는 소관 업무의 수행을 위하여 다음과 같이 개인정보를 수집 및 이용합니다. 수집된 개인정보는 정해진 목적 이외의 용도로는 이용되지 않습니다.<br />※ 관계법령 : 민원사무 처리에 관한 법률 및 동법 시행령, 전자정부법 및 동법 시행령</p>
	</div>
	</div>
	...
	<h5>개인정보의 이용기간 및 보유기간</h5>
	<ul class="basic mat20">
        <li>귀하께서 제공하신 개인정보는 게시물이 삭제될 때 파기합니다. 다만, 다른 법령에 따라 보존하여야 하는 경우에는 그러하지 않을 수 있습니다.
        <ul><li>민원, 제안, 공익신고 등 : 10년</li></ul>
        </li>
	</ul>
