									...
									<div class="cont_write">
										...
										<div class="write_box module_tel">
											...
											<div class="module_w">
												...
												?>
												<input type="text"  title="연락처 첫자리" name="phone_1" id="phone_1" value="<?php echo $phone_1;?>" />
												- <input type="text"  title="연락처 중간자리" name="phone_2" id="phone_2" value="<?php echo $phone_2;?>" />
												- <input type="text"  title="연락처 끝자리" name="phone_3" id="phone_3" value="<?php echo $phone_3;?>"/>
										...
										<?php if ($_SYSTEM['module_config']['board_id'] == 'www_resident_participation') { ?>
											<div class="write_box module_birth">
												<div class="module_t"><label for="birth">생년월일</label></div>
												<div class="module_w">
													<input type="text" name="varchar_1" id="birth" value="<?php echo $data['varchar_2']?>">
													<span class="next mat5"> * 입력예) 1990-01-01</span>
												</div>
											</div>

											<div class="write_box write_inputbox">
												<div class="module_t"><label for="birth">이메일</label></div>
												<div class="module_w">
