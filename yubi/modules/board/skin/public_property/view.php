...
<div class="board_wrapper">
	<div class="module_view_box">
		...
		<div class="contbox">
			<div class="viewinfo">
			<ul>
				<li><span class="subt">소재지</span><?php echo $data['title']; ?></li>
				<li><span class="subt">지 목</span><?php echo $data['varchar_1']; ?></li>
				<li><span class="subt">면적(㎡)</span><?php echo $data['varchar_2']; ?></li>
                <li><span class="subt">관리부서</span><?php echo $data['varchar_3']; ?></li>
				<li><span class="subt">재산용도</span><?php echo $data['varchar_4']; ?></li>
				<li><span class="subt">내용</span><?php echo $data['contents']; ?></li>
			</ul>
		</div>
			<?php  
