...
?>
						<div class="board_wrapper">
                           ...
                           <div class="write_box write_inputbox">										
										...
										<div class="module_w"><input type="text" class="module_text _chk_input" id="title" name="title" value="<?php echo $data['title']; ?>"/><span class="bigo_txt">[읍/면]일 경우는 [읍/면][리]까지입력하여 주시기 바랍니다.</span></div>
									</div>         
                           <div class="write_box write_inputbox">										
							   <div class="module_t"><label for="varchar_1">지목(공부상)<span class="next"><em>(*)</em></span></label></div>
