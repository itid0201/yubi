										...
										<div class="write_contbox">
											<div class="module_t" id="append_btn_zone">
												...
												<ul class="append_btn">
													...
													<!-- li class="image_append" style="display:none;">
														<div class="cont_image_add">
															<input type="file" title="파일첨부" id="cont_image" name="cont_image[]" data-width="<?php /*echo $_SYSTEM['module_config']['contents_img_width_size'];*/ ?>" />
														</div>														
														<?php if($_SYSTEM['module_config']['board_id']!='www_budget') { ?>
