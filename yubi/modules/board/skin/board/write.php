...
//	print_r($module->myinfo);
//	echo '<br>';
//	print_r($module->permission);
//}
############################# contetns #############################
?>
		...
		<div class="module_write_box">
			<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
				...
				<div class="cont_write">
					...
					<?php
						if($_SYSTEM['menu_info']['_board_id'] == 'citizen_illegal_supply_report') {
					...
					<div class="write_box write_inputbox">
						...
						<div class="module_w">
							<div class="split_box r_none">
								<input type="text" name="c_phone_1" id="c_phone_1" value="<?php echo $c_phone_1;?>" class="text_phone module_text _chk_input" maxlength="3" numberonly />
								- <input type="text" name="c_phone_2" id="c_phone_2" value="<?php echo $c_phone_2;?>" class="text_phone module_text _chk_input" maxlength="4" numberonly />
								- <input type="text" name="c_phone_3" id="c_phone_3" value="<?php echo $c_phone_3;?>" class="text_phone module_text _chk_input" maxlength="4" numberonly />
							</div>
						</div>
					</div>
					<?php } ?>
					<?php 
					if($_SYSTEM['module_config']['board_id'] == 'www_patents'){
					?>
						<div class="write_box">
							<div class="module_t">	
								<label for="varchar_8">특허번호</label>
							</div>
							<div class="module_w">	
								<input type="text" name="varchar_8" id="varchar_8" class="module_text" value="<?php echo $varchar_8; ?>" />
							</div>
						</div>
					<?php } ?>
					<?php 
					if($_SYSTEM['module_config']['board_id'] == 'citizen_compliment'){
					?>
						<div class="write_box">
							<div class="module_t">	
							...
							<ul class="append_btn">
								...
								<li class="image_append">
									<div class="cont_image_add" style="display:none;">
										<input type="file" id="cont_image" title="이미지 파일 첨부" title="이미지 파일 첨부" name="cont_image[]" data-width="<?php echo $_SYSTEM['module_config']['contents_img_width_size']; ?>" />
									</div>
