...
?>
								...
								<form id="write_form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="selectForm" enctype="multipart/form-data">
									...
									<div class="cont_write">
										...
										<div class="write_box module_theme">
											<div class="module_t"><label for="category_1">카테고리</label></div>
											<div class="module_w">
										...
										<div class="write_box write_inputbox">
											<div class="module_t"><label for="phone_1">연락처<em>(*)</em></label></div>
											<div class="module_w">
										...
										<?php } ?>
                                        <?php 
                                            //20230206::이광배::지방보조금 부정수급 신고 핸드폰 추가
                                            if($_SYSTEM['module_config']['board_id'] == 'citizen_illegal_supply_report') {
												if(!empty($data['c_phone_1']) || !empty($data['c_phone_2']) || !empty($data['c_phone_3'])) {
													$c_phone_1 = $data['c_phone_1'];
													$c_phone_2 = $data['c_phone_2'];
													$c_phone_3 = $data['c_phone_3'];
												} else {
													if(!empty($data['c_phone'])) list($c_phone_1, $c_phone_2, $c_phone_3) = explode('-',$data['c_phone']);
												} 
                                        ?>
										<div class="write_box write_inputbox">
											<div class="module_t"><label for="c_phone_1">핸드폰<em>(*)</em></label></div>
											<div class="module_w">
												<input type="text" name="c_phone_1" id="c_phone_1" value="<?php echo $c_phone_1;?>" class="w30" size="4" maxlength="3" numberonly />
												- <input type="text" name="c_phone_2" id="c_phone_2" value="<?php echo $c_phone_2;?>" class="w30" size="4" maxlength="4" numberonly />
												- <input type="text" name="c_phone_3" id="c_phone_3" value="<?php echo $c_phone_3;?>" class="w30" size="4" maxlength="4" numberonly />
												<span class="next mat5"> * 입력예) 010-1234-1234</span>
											</div>
										</div>
										<?php } ?>
										<?php 
										if($_SYSTEM['menu_info']['_board_id'] == 'citizen_compliment'){
										?>
											<div class="write_box">
												<div class="module_t">	
													<label for="varchar_1">연락처</label>
												</div>
												<div class="module_w">	
													<input type="text" name="varchar_1" id="varchar_1" class="module_text" value="<?php echo $varchar_1; ?>" />
												</div>
											</div>
										<?php } ?>
										<?php
												...
												<ul class="append_btn">
													...
													<li class="image_append">
														<div class="cont_image_add" style="display:none;">
															<input type="file" id="cont_image" title="이미지 파일 첨부" name="cont_image[]" data-width="<?php echo $_SYSTEM['module_config']['contents_img_width_size']; ?>" />
														</div>														
   ...
   <?php 
                                        ...
                                        <div class="write_box">
											...
											<div class="module_w">
												<input type="text" class="input_basic phone" name="phone_1" id="phone_1" value="<?php if(empty($data['phone_1'])) echo $data['user_phone_1']; else echo $data['phone_1'] ?>" /> - <input type="text" class="input_basic phone" name="phone_2" id="phone_2" value="<?php if(empty($data['phone_2'])) echo $data['user_phone_2']; else echo $data['phone_2'] ?>" /> - <input type="text" class="input_basic phone" name="phone_3" id="phone_3" value="<?php if(empty($data['phone_3'])) echo $data['user_phone_3']; else echo $data['phone_3'] ?>" />
											</div>
										</div>
                                        <div class="write_box notice_box">
											<div class="module_t">	
											...
											<div class="module_w">	
												<input type="text" class="input_basic" name="varchar_2" id="varchar_2" value="<?php if(empty($data['varchar_2'])) echo $data['user_birth']; else echo $data['varchar_2'] ?>" />
											</div>
										</div>
                                        ...
                                        <?php 
                                         ...
                                         ## 나주청년센터 금융상담 추가
                                            if($_SYSTEM['module_config']['board_id'] == 'najuyouth_request') {
                                                ...
                                                <div class="module_t">	
                                                    <label for="varchar_1">상담예약</label>
                                                </div>
                                                <div class="module_w">	
                                                    <input type="radio" name="varchar_1" id="varchar_1" value="y"';
                                                if($data['varchar_1'] == 'y') echo 'checked';
                                                echo ' /><label for="varchar_1">신청</label>
                                                </div>
                                            </div>';
                                            }
										...
										<div class="write_box module_file">
											<div class="module_t"><strong>파일첨부</strong><?php echo ( $_SYSTEM['module_config']['use_file_check'] == 'true')?'<em>(*)</em>':''?></div>
											<div class="module_w">		
										...
										?>
											...
											<div class="write_box module_privacy">
												<div class="module_t"><strong><?php echo ($_SYSTEM['module_config']['board_id'] !== 'task_review_committee') ? '개인정보처리방침' : '서약서'?></strong></div>
												<div class="module_w">
													<p class="joinPoint"><?php echo ($_SYSTEM['module_config']['board_id'] !== 'task_review_committee') ? '아래 개인정보처리방침을 반드시 읽어보시고 "동의"에 체크하신 후 "확인"버튼을 눌러주세요' : ''?></p>
													<p>
													...
													<p>
														<label for="agree_privacy"><?php echo ($_SYSTEM['module_config']['board_id'] !== 'task_review_committee') ? '개인정보처리방침에 동의합니다' : '서약서에 동의합니다.'?></label>
...
<script src="<?php echo $_SERVER['SELF']; ?>js/write_mobile.js?build=<?php echo SERIAL;?>" ></script>