...
<div class="module_view_box">
  ...
  <div class="contbox">
    	...
    	<?php
		  ...
		  echo '<div class="show_movie"><iframe width="100%" height="300px" src="https://www.youtube.com/embed/'.$data['link_url'].'"  frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="position: absolute; width:100%; height:100%;" title="'.str_replace('"','&quot;',$data['contents']).'"></iframe></div>';
		  echo '<div class="movie_cont">';
		  //echo $data['contents'];
		  echo $contents;
		  echo '</div>';
