									...
									<div class="cont_write">										   
										...
										<div class="write_box write_inputbox">
											...
											<div class="module_w">
												...
												?>
												<input type="text" name="phone_1" id="phone_1" value="<?php echo $phone_1;?>" class="w30" numberonly />
												- <input type="text" name="phone_2" id="phone_2" value="<?php echo $phone_2;?>" class="w30" numberonly />
												- <input type="text" name="phone_3" id="phone_3" value="<?php echo $phone_3;?>" class="w30" numberonly/>
