...
//		$print_table_tr  .=  '								<td>'.$buffer['visit_cnt'].'</td>';
		...
		$print_table_tr  .=  '								<td class="depart">'.$buffer['process_3'].'</td>';		
		$print_table_tr  .=  '							</tr>';
	}	
...
//	$print_table .=  '									<th scope="col" class="th_70px">조회수</th>';	
	...
	$print_table .=  '									<th scope="col" class="th_120px">처리부서</th>';
	$print_table .=  '								</tr>';
	$print_table .=  '							</thead>';
	$print_table .=  '							<tbody>';
				...
				echo 			'<div class="alert_btn_box mat20">';
								if($_SYSTEM['myinfo']['is_login'] == true) {
									if($_SYSTEM['module_config']['board_id'] != 'www_inconvenience' && $_SYSTEM['module_config']['board_id'] != 'www_reaulatory_reform' && $_SYSTEM['module_config']['board_id'] != 'www_poor' && $_SYSTEM['module_config']['board_id'] != 'www_newspaper' && $_SYSTEM['module_config']['board_id'] != 'www_pollution' && $_SYSTEM['module_config']['board_id'] != 'www_cyber_disaster' ) {
										echo '<a href="?mode=write" class="alert_btn btn_reportform"><span>글쓰기</span></a>';					
									...
									if($_SYSTEM['module_config']['board_id'] != 'www_inconvenience' && $_SYSTEM['module_config']['board_id'] != 'www_reaulatory_reform' && $_SYSTEM['module_config']['board_id'] != 'www_poor' && $_SYSTEM['module_config']['board_id'] != 'www_newspaper' && $_SYSTEM['module_config']['board_id'] != 'www_pollution' && $_SYSTEM['module_config']['board_id'] != 'www_cyber_disaster') {
									echo '<a href="'.$_SYSTEM['rep_login'].$_SERVER['PHP_SELF'].'?mode=write" class="alert_btn btn_reportform"><span class="btn1hover1"></span><span>글쓰기</span></a>';
...
if($mode =='list' ) {
		...
		if($data['use_category_1'] == 'true') {
			...
			echo print_category($data['category_1'], $category_1_list , $category_1_all, $category_parameter, $_SERVER['PHP_SELF'] );			
		}
		## -----------  카테고리 : end
